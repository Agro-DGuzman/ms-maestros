...
final class Envelope
{
    ...
    public static function fallo(Error $error): array
    {
        ...
        return [
            ...
            'success' => false,
            'error' => [
                'code' => array_values(array_map(static fn (Error $e): string => $e->code, $errores)),
                'description' => $error->description,
                'structuredMessage' => array_values(
                    array_map(static fn (Error $e): string => $e->structuredMessage, $errores),
                ),
